...
final class SafeMethodCachingInterceptor implements ClientInterceptor {
    ...
    public static SafeMethodCachingInterceptor newSafeMethodCachingInterceptor(Map cache) {
    ...
    private final Map<Key, Value> internalCache;
    private final int defaultMaxAge;

    private SafeMethodCachingInterceptor(Map cache, int defaultMaxAge) {
